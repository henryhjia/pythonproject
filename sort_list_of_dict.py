...
def main() -> None:
  ...
  print(format(order, '3d'), me.sort_by_price_ascending_by_price_ast_literal_eval(str1, 'price'))
  order += 1

  print(format(order, '3d'), me.sort_by_price_ascending_by_price_json_loads(str1, 'price'))
  order += 1

  print(f'{order: 3d}', me.sort_by_price_ascending_by_name_ast_literal_eval(str1, 'name'))
  order += 1

  print(f'{order: 3d}', me.sort_by_price_ascending_by_name_json_loads(str1, 'name'))
  order += 1

  print(f'{order: 3d}', me.sort_by_price_descending_by_name(str1, 'name'))
  order += 1

  print(f'{order: 3d}', me.sort_by_price_descending_by_price(str1, 'price'))
  order += 1
